...
export class SupabaseOverrideService implements IOverrideService {
  ...
  async startOverride(zoneId: string, durationMinutes: number, reason?: string, mode: 'water' | 'fertigation' = 'water', target?: 'pump' | 'pump_pupuk'): Promise<void> {
  ...
  async stopOverride(overrideId: string, target?: 'pump' | 'pump_pupuk'): Promise<void> {
